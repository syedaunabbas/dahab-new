...
class MultiCurrencyRefundsTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRefunds()
    {
        ...
        $this->tests->refundOnline($invoice, ['simple-product' => 1, 'virtual-monthly-subscription-product' => 1], $shipping = 4.25);
        ...
        $this->assertTrue($order->canCreditmemo());
        $this->tests->refundOnline($invoice, ['simple-trial-monthly-subscription-product' => 1], $shipping = 4.25);
        ...
        $expected = [
            ['amount' => 1583, 'amount_captured' => 1583, 'amount_refunded' => 1583, 'currency' => 'eur'],
            ['amount' => 1583, 'amount_captured' => 1583, 'amount_refunded' => 1583, 'currency' => 'eur'],
            ['amount' => 1083, 'amount_captured' => 1083, 'amount_refunded' => 1083, 'currency' => 'eur'],
        ];
