...
namespace StripeIntegration\Payments\Test\Integration\Frontend\PRAPI;

class NormalOrderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAddresses($shippingAddress, $billingAddress, $payerDetails)
    {
        ...
        // $event->triggerPaymentIntentEvents($paymentIntent, $this);
