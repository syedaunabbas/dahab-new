<?php
namespace Custom\Merchant\Setup;
...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY,'number_of_products',	[
        ...
        $sampleAttribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'number_of_products')
            ->addData(
                [
